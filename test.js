...
async function mua_dinh_ban_day() {
       ...
       ((min_sell_bitmart_volume * min_sell_bitmart_price) > 5))
    {
        ...
        // dat lenh
//        const my_order_bitmart = await lbank.fetchOpenOrders('CFXT_USDT', undefined, undefined);
//        // id cua lenh dat
//        const my_order_bitmart_id = my_order_bitmart[0].id;
//        // them kiem tra lenh thanh cong chua
//        const order_bitmart = await bitmart.fetchOrderSupplement(my_order_bitmart_id, 'CFXT_USDT');
//        while(order_bitmart.info.status != '1')
//        {
//        }
...
//        while(order_lbank.info.status != '1')
//        {
//        }
...
//        // id cua lenh dat  
//        const my_order_bitmart = await bitmart.fetchOpenOrders('CFXT_USDT', undefined, undefined);
//        const my_order_bitmart_id = my_order_bitmart[0].id;
//        // them kiem tra lenh thanh cong chua
//        const order_bitmart = await bitmart.fetchOrderSupplement(my_order_bitmart_id, 'CFXT_USDT');
//        while(order_bitmart.info.status != '1')
...
//        }
    ...
    // trang thai lenh dat
//    const my_order_sts = await lbank.fetchOrder(my_order_id,'cfxt_usdt', undefined);


//    console.log(my_order_id);
//    console.log(my_order_sts);
//    console.log(min_sell_lbank_price);
//    console.log(min_sell_lbank_volume);
//    console.log(max_buy_lbank_price);
//    console.log(max_buy_lbank_volume);
//
//    console.log(min_sell_bitmart_price);
//    console.log(min_sell_bitmart_volume);
//    console.log(max_buy_bitmart_price);
//    console.log(max_buy_bitmart_volume);
}
